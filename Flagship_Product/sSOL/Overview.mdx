---
title: "sSOL"
description: "Solayer’s liquid staking token for the Solana network."
---

# Introduction to sSOL

**sSOL** is a core component of the **Solayer protocol and Mega Validaator**, serving as a **liquid staking token** that represents **Deposited SOL** on the **Solana**. It allows users to **earn staking rewards while maintaining asset liquidity**, enabling seamless participation in **decentralized finance (DeFi) applications**.
