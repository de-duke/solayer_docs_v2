...
description: "InfiniSVM’s fine-grained transaction scheduling model for optimized parallel execution."
---

# Transaction Semantic Aware Scheduling in InfiniSVM
